...
var PessoaPersistComponent = (function () {
    function PessoaPersistComponent(pessoaService, route, router) {
        this.pessoaService = pessoaService;
        this.route = route;
        this.router = router;
        this.pessoa = {};
    }
    PessoaPersistComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    PessoaPersistComponent.prototype.persist = function () {
    ...
    PessoaPersistComponent.prototype.insert = function () {
        var _this = this;
    ...
    PessoaPersistComponent.prototype.update = function () {
        var _this = this;
    ...
    return PessoaPersistComponent;
}());
PessoaPersistComponent = __decorate([
    core_1.Component({
...
exports.PessoaPersistComponent = PessoaPersistComponent;
//# sourceMappingURL=pessoa.persist.component.js.map